...
function cleanedCounts(data) {
    console.log(data)
    // We will keep the first index of the array.
    //we have to find the "odd" number that is not following the pattern
    //we probably might need to compare the other indexes meaning conditionals at some point
    //we will most likely use a loop to see what integers are good
    // we will make a new array to eventually return 
    let result = []
    let initial = 0
