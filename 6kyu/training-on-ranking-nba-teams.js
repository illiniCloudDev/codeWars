...
function nbaCup(resultSheet, toFind) {
  //Params are a string and a value
  //Return a formatted string
  //Ex
  //Pseudo code
  
  //turn the resultSheet into an array to use find() method
  //does second param exist in the string?
  //conditional if the second param isn't found
  //
  
  let found = false 
  let stringsArr = resultSheet.split(',')
  
//   console.log(stringsArr)
  for( let match of stringsArr){
    if(match.includes(toFind)){
