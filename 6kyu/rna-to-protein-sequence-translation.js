...
//   let splitRna = rna.split('')
  
  let pairsOfThree = []
  //create a for loop that will take the sequence into sets of 3

   for (let i=0; i<rna.length; i+=3){
   pairsOfThree.push(rna.slice(i,i+3))
 }
  console.log(pairsOfThree)
  return pairsOfThree.map(v=>object[v]).join``
